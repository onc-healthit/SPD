...
public class VhDirOrganization_MH extends DomainResource {
     ...
     */
    @Child(name = "partOf", type = {VhDirOrganization_MH.class}, order=11, min=0, max=1, modifier=false, summary=true)
     ...
     */
    protected VhDirOrganization_MH partOfTarget;
    ...
    public VhDirOrganization_MH setDescription(String value) { 
	...
	public VhDirOrganization_MH addDigitalcertficate(VhDirDigitalCertificate t) {
	    if (t == null)
	      return this;
	...
	public VhDirOrganization_MH addQualification(VhDirQualification t) {
	    if (t == null)
	      return this;
	...
	public VhDirOrganization_MH addTelecom(VhDirContactPoint t) {
	    if (t == null)
	      return this;
     ...
     */
    public VhDirOrganization_MH setAddress(List<VhDirAddress> theAddress) { 
    ...
    public VhDirOrganization_MH addAddress(VhDirAddress t) { //3
      if (t == null)
        return this;
      if (this.address == null)
        this.address = new ArrayList<VhDirAddress>();
     ...
     */
    public VhDirOrganization_MH setActiveElement(BooleanType value) { 
      this.active = value;
      return this;
    }
     ...
     */
    public VhDirOrganization_MH setActive(boolean value) { 
        if (this.active == null)
     ...
     * @return Returns a reference to <code>this</code> for easy method chaining
     */
    public VhDirOrganization_MH setType(List<CodeableConcept> theType) { 
      this.type = theType;
      return this;
    }
    ...
    public VhDirOrganization_MH addType(CodeableConcept t) { //3
      if (t == null)
        return this;
      if (this.type == null)
        this.type = new ArrayList<CodeableConcept>();
     ...
     */
    public VhDirOrganization_MH setNameElement(StringType value) { 
      this.name = value;
      return this;
    }
     ...
     */
    public VhDirOrganization_MH setName(String value) { 
      if (Utilities.noString(value))
        this.name = null;
      else {
        if (this.name == null)
	...
	public VhDirOrganization_MH addIdentifier(VhDirIdentifier t) { //3
	    if (t == null)
	      return this;
    ...
    public VhDirOrganization_MH setPartOf(Reference value) { 
      this.partOf = value;
      return this;
    }

    public VhDirOrganization_MH getPartOfTarget() { 
      if (this.partOfTarget == null)
        if (Configuration.errorOnAutoCreate())
          throw new Error("Attempt to auto-create Organization.partOf");
        else if (Configuration.doAutoCreate())
          this.partOfTarget = new VhDirOrganization_MH(); // aa
      return this.partOfTarget;
    }

    public VhDirOrganization_MH setPartOfTarget(VhDirOrganization_MH value) { 
      this.partOfTarget = value;
      return this;
    }
    
    public VhDirOrganization_MH setAlias(List<VhDirAlias> theAlias) { 
      this.alias = theAlias;
      return this;
    }
     ...
     */
    public VhDirOrganization_MH addAlias(VhDirAlias value) { //1
      if (this.alias == null)
        this.alias = new ArrayList<VhDirAlias>();
    ...
    public VhDirOrganization_MH setContact(List<OrganizationContactComponent> theContact) { 
    ...
    public VhDirOrganization_MH addContact(OrganizationContactComponent t) { //3
      if (t == null)
        return this;
      if (this.contact == null)
        this.contact = new ArrayList<OrganizationContactComponent>();
	...
	public VhDirOrganization_MH addEndpoint(Reference t) {
	    if (t == null)
	      return this;
	...
	public VhDirOrganization_MH addUsageRestriction(Reference t) {
	    if (t == null)
	      return this;
