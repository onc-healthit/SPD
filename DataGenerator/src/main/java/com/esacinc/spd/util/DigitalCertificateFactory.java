...
public class DigitalCertificateFactory implements IDigitalCertificate {
	...
	static public VhDirDigitalCertificate makeDigitalCertificate(int nth, String type, String use, String trustFramework, String standard, Date expiration) {
		...
		ErrorReport.writeInfo("VhDirDigitalCertificate", "", "DigitalCertificateFactory.makeDigitalCertificate", String.format("Created a fake digital certificate with args: %d, %s, %s, %s, %s, %s",nth, type, use, trustFramework, standard, expiration) );
		return cert;
	}
