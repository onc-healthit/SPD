...
CREATE TABLE IF NOT EXISTS `spd`.`actor` (
  ...
  `provision_id` INT(11) NULL DEFAULT NULL COMMENT 'Who|what controlled by this rule (or group, by role)',
...
CREATE TABLE IF NOT EXISTS `spd`.`available_time` (
  ...
  `available_start_time` DATETIME NULL DEFAULT NULL,
  `available_end_time` DATETIME NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `spd`.`fhir_codeable_concept` (
  ...
  `endpoint_contact__id` INT(11) NULL DEFAULT NULL,
  ...
  INDEX `fk_codeable_concept_endpoint_contact1_idx` (`endpoint_contact__id` ASC) ,
  ...
  CONSTRAINT `fk_codeable_concept_endpoint1`
    ...
    REFERENCES `spd`.`vhdir_endpoint` (`endpoint_id`),
  CONSTRAINT `fk_codeable_concept_endpoint_contact1`
    FOREIGN KEY (`endpoint_contact__id`)
    REFERENCES `spd`.`endpoint_contact` (`endpoint_contact_id`),
...
CREATE TABLE IF NOT EXISTS `spd`.`identifier` (
  ...
  `identifier_status` VARCHAR(15) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `spd`.`participant` (
  ...
  INDEX `fk_participant_vhdir_careteam1_idx` (`member_careteam_id` ASC) ,
  INDEX `fk_participant_vhdir_practitioner_role1_idx` (`member_practitioner_role_id` ASC) ,
  INDEX `fk_participant_vhdir_organization1_idx` (`member_organization_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `spd`.`telecom` (
  ...
  INDEX `telecom_organization_affiliation_id_idx` (`organization_affiliation_id` ASC) ,
  INDEX `telecom_practitioner_id_idx` (`practitioner_id` ASC) ,
  INDEX `telecom_practitioner_role_id_idx` (`practitioner_role_id` ASC) ,
  INDEX `fk_telecom_organization1_idx` (`organization_id` ASC) ,
...
-- -----------------------------------------------------
-- Table `spd`.`unavailable_time`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd`.`unavailable_time` ;

CREATE TABLE IF NOT EXISTS `spd`.`unavailable_time` (
  ...
  `during_start_time` DATETIME NULL DEFAULT NULL,
  `during_end_time` DATETIME NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `spd`.`use_case` (
  ...
  `type_cct_id` INT(11) NOT NULL COMMENT 'Type\nBinding: VhDir Use Case Type (example)',
...
-- Table `spd`.`vhdir_ehr`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd`.`vhdir_ehr` ;

CREATE TABLE IF NOT EXISTS `spd`.`vhdir_ehr` (
...
CREATE TABLE IF NOT EXISTS `spd`.`vhdir_endpoint` (
  ...
  `iinsurance_plan_id` INT(11) NULL DEFAULT NULL COMMENT 'Technical endpoint',
  ...
  INDEX `fk_endpoint_organization_contact1_idx` (`organization_contact_id` ASC) ,
  ...
  INDEX `fk_endpoint_insurance_plan1_idx` (`iinsurance_plan_id` ASC) ,
  ...
  CONSTRAINT `fk_endpoint_insurance_plan1`
    FOREIGN KEY (`iinsurance_plan_id`)
    REFERENCES `spd`.`vhdir_insurance_plan` (`insurance_plan_id`),
  ...
  CONSTRAINT `fk_endpoint_organization_affiliation1`
    FOREIGN KEY (`organization_affiliation_id`)
    REFERENCES `spd`.`vhdir_organization_affiliation` (`organization_affiliation_id`),
  CONSTRAINT `fk_endpoint_organization_contact1`
    FOREIGN KEY (`organization_contact_id`)
    REFERENCES `spd`.`organization_contact` (`organization_contact_id`),
...
CREATE TABLE IF NOT EXISTS `spd`.`vhdir_practitioner` (
  ...
  INDEX `fk_practitioner_practitioner_role1_idx` (`practitioner_role_id` ASC) ,
  INDEX `fk_practitioner_meta_data1_idx` (`meta_data_id` ASC) ,
  CONSTRAINT `fk_practitioner_meta_data1`
    FOREIGN KEY (`meta_data_id`)
    REFERENCES `spd`.`fhir_meta_data` (`meta_data_id`),
  CONSTRAINT `fk_practitioner_practitioner_role1`
    FOREIGN KEY (`practitioner_role_id`)
    REFERENCES `spd`.`vhdir_practitioner_role` (`practitioner_role_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1
...
CREATE TABLE IF NOT EXISTS `spd`.`vhdir_validation` (
  ...
  `failure_action_cc_id` INT(11) NULL DEFAULT NULL COMMENT 'fatal | warn | rec-only | none\nBinding: failure-action (preferred)',
  `validator_certificate` VARCHAR(45) NULL DEFAULT NULL COMMENT 'A digital identity certificate associated with the validator',
  `validator_signature` VARCHAR(45) NULL DEFAULT NULL,
