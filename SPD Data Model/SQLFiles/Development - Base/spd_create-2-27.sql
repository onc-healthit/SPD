...
CREATE TABLE IF NOT EXISTS `spd`.`vhdir_organization` (
  ...
  `name` VARCHAR(45) NOT NULL DEFAULT 'organization' COMMENT 'Name used for the organization',
...
CREATE TABLE IF NOT EXISTS `spd`.`vhdir_practitioner` (
  ...
  `gender` TINYINT(3) NULL DEFAULT NULL COMMENT 'male | female | other | unknown\nBinding: AdministrativeGender (required)',
