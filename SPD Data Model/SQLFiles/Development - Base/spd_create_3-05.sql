...
CREATE TABLE IF NOT EXISTS `spd`.`available_time` (
  ...
  INDEX `fk_available_time_endpoint_contact1_idx` (`endpoint_contact_available_time_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_available_time_endpoint_contact1`
    ...
    REFERENCES `spd`.`endpoint_contact` (`endpoint_contact_id`),
...
-- -----------------------------------------------------
-- Table `spd`.`communication_proficiency`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd`.`communication_proficiency` ;

CREATE TABLE IF NOT EXISTS `spd`.`communication_proficiency` (
  ...
  INDEX `fk_communication_proficiency_communication1_idx` (`communication_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `spd`.`cost_benefit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd`.`cost_benefit` ;

CREATE TABLE IF NOT EXISTS `spd`.`cost_benefit` (
...
-- -----------------------------------------------------
-- Table `spd`.`cost_benefit_individual_cost`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd`.`cost_benefit_individual_cost` ;

CREATE TABLE IF NOT EXISTS `spd`.`cost_benefit_individual_cost` (
  ...
  CONSTRAINT `fk_cost_benefit_individual_cost_cost_benefit1`
    ...
    REFERENCES `spd`.`cost_benefit` (`cost_benefit_id`),
...
CREATE TABLE IF NOT EXISTS `spd`.`ehr` (
  ...
  INDEX `fk_vhdir_ehr_fhir_codeable_concept1_idx` (`patient_access_cc_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `spd`.`endpoint_contact`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd`.`endpoint_contact` ;

CREATE TABLE IF NOT EXISTS `spd`.`endpoint_contact` (
...
CREATE TABLE IF NOT EXISTS `spd`.`fhir_codeable_concept` (
  ...
  INDEX `fk_codeable_concept_practitioner1_idx` (`practitioner_accessibiliy_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_fhir_codeable_concept_cost_benefit_individual_cost1`
    ...
    REFERENCES `spd`.`cost_benefit_individual_cost` (`cost_benefit_individual_cost_id`),
...
CREATE TABLE IF NOT EXISTS `spd`.`new_patients` (
  ...
  INDEX `fk_new_patients_vhdir_network_idx` (`network_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `spd`.`organization_contact`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd`.`organization_contact` ;

CREATE TABLE IF NOT EXISTS `spd`.`organization_contact` (
  ...
  INDEX `fk_organization_contact_codeable_concept1_idx` (`purpose_id` ASC) VISIBLE,
  INDEX `fk_organization_contact_name1_idx` (`name_id` ASC) VISIBLE,
  INDEX `fk_organization_contact_address1_idx` (`address_id` ASC) VISIBLE,
  INDEX `fk_organization_contact_vhdir_organization1_idx` (`organization_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `spd`.`participant` (
  ...
  `period_start` DATETIME NULL DEFAULT NULL,
  `period_end` DATETIME NULL DEFAULT NULL,
  `member_careteam_id` INT(11) NULL DEFAULT NULL,
  `member_practitioner_role_id` INT(11) NULL DEFAULT NULL,
  `member_organization_id` INT(11) NULL DEFAULT NULL,
  PRIMARY KEY (`participant_id`),
  INDEX `fk_participant_vhdir_careteam1_idx` (`member_careteam_id` ASC) VISIBLE,
  INDEX `fk_participant_vhdir_practitioner_role1_idx` (`member_practitioner_role_id` ASC) VISIBLE,
  INDEX `fk_participant_vhdir_organization1_idx` (`member_organization_id` ASC) VISIBLE,
  CONSTRAINT `fk_participant_vhdir_careteam1`
    FOREIGN KEY (`member_careteam_id`)
    REFERENCES `spd`.`vhdir_careteam` (`careteam_id`),
  CONSTRAINT `fk_participant_vhdir_organization1`
    FOREIGN KEY (`member_organization_id`)
    REFERENCES `spd`.`vhdir_organization` (`organization_id`),
  CONSTRAINT `fk_participant_vhdir_practitioner_role1`
    FOREIGN KEY (`member_practitioner_role_id`)
    REFERENCES `spd`.`vhdir_practitioner_role` (`practitioner_role_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd`.`plan_benefit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd`.`plan_benefit` ;

CREATE TABLE IF NOT EXISTS `spd`.`plan_benefit` (
...
CREATE TABLE IF NOT EXISTS `spd`.`resource_reference` (
  ...
  `reference` VARCHAR(45) NULL DEFAULT NULL COMMENT 'Literal reference, Relative, internal or absolute URL',
  `type` VARCHAR(45) NULL DEFAULT NULL COMMENT 'Type the reference refers to (e.g. \"Patient\")\nResourceType (Extensible)',
  `identifier` VARCHAR(45) NULL DEFAULT NULL COMMENT 'Logical reference, when literal reference is not known',
  `display` VARCHAR(45) NULL DEFAULT NULL COMMENT 'Text alternative for the resource',
...
CREATE TABLE IF NOT EXISTS `spd`.`specific_cost` (
  ...
  INDEX `fk_specific_cost_vhdir_insurance_plan1_idx` (`insurance_plan_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `spd`.`telecom` (
  ...
  `practitioner_role_id` INT(11) NULL DEFAULT NULL COMMENT 'Contact details that are specific to the role/location/service',
  `organization_id` INT(11) NULL DEFAULT NULL,
  ...
  INDEX `telecom_organization_affiliation_id_idx` (`organization_affiliation_id` ASC) VISIBLE,
  INDEX `telecom_practitioner_id_idx` (`practitioner_id` ASC) VISIBLE,
  INDEX `telecom_practitioner_role_id_idx` (`practitioner_role_id` ASC) VISIBLE,
  INDEX `fk_telecom_organization1_idx` (`organization_id` ASC) VISIBLE,
  INDEX `fk_telecom_organization_contact1_idx` (`organization_contact_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_telecom_location1`
    FOREIGN KEY (`location_id`)
    REFERENCES `spd`.`vhdir_location` (`location_id`),
  CONSTRAINT `fk_telecom_organization1`
    FOREIGN KEY (`organization_id`)
    REFERENCES `spd`.`vhdir_organization` (`organization_id`),
  CONSTRAINT `fk_telecom_organization_contact1`
    FOREIGN KEY (`organization_contact_id`)
    REFERENCES `spd`.`organization_contact` (`organization_contact_id`),
  CONSTRAINT `telecom_organization_affiliation_id`
    FOREIGN KEY (`organization_affiliation_id`)
    REFERENCES `spd`.`vhdir_organization_affiliation` (`organization_affiliation_id`)
    ON DELETE CASCADE,
  CONSTRAINT `telecom_practitioner_id`
    ...
    REFERENCES `spd`.`vhdir_practitioner` (`practitioner_id`)
    ON DELETE CASCADE,
  CONSTRAINT `telecom_practitioner_role_id`
    FOREIGN KEY (`practitioner_role_id`)
    REFERENCES `spd`.`vhdir_practitioner_role` (`practitioner_role_id`)
    ON DELETE CASCADE)
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `spd`.`vhdir_endpoint` (
  ...
  INDEX `fk_endpoint_endpoint_contact1_idx` (`endpoint_contact_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `spd`.`vhdir_healthcare_service` (
  ...
  INDEX `fk_healthcare_service_name1_idx` (`name_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `spd`.`vhdir_insurance_plan` (
  ...
  INDEX `fk_insurance_plan_organization2_idx` (`owned_by_organization_id` ASC) VISIBLE,
  INDEX `fk_insurance_plan_organization3_idx` (`administered_by_organization_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `spd`.`vhdir_location` (
  ...
  INDEX `fk_vhdir_location_fhir_codeable_concept1_idx` (`physcial_type_cc_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `spd`.`vhdir_network` (
  ...
  INDEX `fk_network_insurance_plan1_idx` (`insurance_plan_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `spd`.`vhdir_organization` (
  ...
  `name` VARCHAR(70) NOT NULL DEFAULT 'organization' COMMENT 'Name used for the organization',
  `description` VARCHAR(45) NULL DEFAULT NULL,
  `partOf_organization_name` VARCHAR(70) NULL,
...
CREATE TABLE IF NOT EXISTS `spd`.`vhdir_restriction` (
  ...
  INDEX `fk_restriction_practitioner1_idx` (`practitioner_id` ASC) VISIBLE,
  INDEX `fk_restriction_practitioner_role1_idx` (`practitioner_role_id` ASC) VISIBLE,
  INDEX `fk_restriction_organization1_idx` (`organization_id` ASC) VISIBLE,
  INDEX `fk_restriction_organization_affiliation1_idx` (`organization_affiliation_id` ASC) VISIBLE,
  INDEX `fk_restriction_careteam1_idx` (`careteam_id` ASC) VISIBLE,
  INDEX `fk_restriction_endpoint1_idx` (`endpoint_id` ASC) VISIBLE,
  INDEX `fk_restriction_healthcare_service1_idx` (`healthcare_service_id` ASC) VISIBLE,
  INDEX `fk_restriction_location1_idx` (`location_id` ASC) VISIBLE,
  INDEX `fk_restriction_network1_idx` (`network_id` ASC) VISIBLE,
  ...
  INDEX `fk_restriction_insurance_plan1_idx` (`insurance_plan_id` ASC) VISIBLE,
