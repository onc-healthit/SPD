...
-- Schema spd_scrubbed
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `spd_scrubbed` ;

-- -----------------------------------------------------
-- Schema spd_scrubbed
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `spd_scrubbed` DEFAULT CHARACTER SET utf8 ;
USE `spd_scrubbed` ;

-- -----------------------------------------------------
-- Table `spd_scrubbed`.`actor`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`actor` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`actor` (
  ...
  CONSTRAINT `fk_actor_provision1`
    ...
    REFERENCES `spd_scrubbed`.`provision` (`provision_id`),
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`address`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`address` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`address` (
  ...
  CONSTRAINT `fk_address_network1`
    ...
    REFERENCES `spd_scrubbed`.`vhdir_network` (`network_id`),
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`attestation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`attestation` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`attestation` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`available_time`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`available_time` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`available_time` (
  ...
  CONSTRAINT `fk_available_time_telecom1`
    ...
    REFERENCES `spd_scrubbed`.`telecom` (`telecom_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`care_team_alias`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`care_team_alias` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`care_team_alias` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`communication`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`communication` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`communication` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`consent`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`consent` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`consent` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`contact`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`contact` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`contact` (
  ...
  CONSTRAINT `fk_contact_name1`
    FOREIGN KEY (`name_id`)
    REFERENCES `spd_scrubbed`.`name` (`name_id`),
  CONSTRAINT `fk_contact_vhdir_insurance_plan1`
    FOREIGN KEY (`insurance_plan_id`)
    REFERENCES `spd_scrubbed`.`vhdir_insurance_plan` (`insurance_plan_id`),
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`coverage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`coverage` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`coverage` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`coverage_benefit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`coverage_benefit` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`coverage_benefit` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`digital_certificate`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`digital_certificate` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`digital_certificate` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`ehr`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`ehr` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`ehr` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`eligibility`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`eligibility` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`eligibility` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`encounter_reference`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`encounter_reference` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`encounter_reference` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`fhir_codeable_concept`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`fhir_codeable_concept` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`fhir_codeable_concept` (
  ...
  CONSTRAINT `fk_codeable_concept_organization_affiliation1`
    ...
    REFERENCES `spd_scrubbed`.`vhdir_organization_affiliation` (`organization_affiliation_id`),
  ...
  CONSTRAINT `fk_codeable_concept_qualification1`
    ...
    REFERENCES `spd_scrubbed`.`qualification` (`qualification_id`),
  ...
  CONSTRAINT `fk_fhir_codeable_concept_cost_benefit_individual_cost1`
    ...
    REFERENCES `spd_scrubbed`.`specific_cost_benefit_cost` (`cost_benefit_individual_cost_id`),
  CONSTRAINT `fk_fhir_codeable_concept_participant1`
    FOREIGN KEY (`careteam_participant_role_id`)
    REFERENCES `spd_scrubbed`.`participant` (`participant_id`),
  CONSTRAINT `fk_fhir_codeable_concept_primary_source1`
    FOREIGN KEY (`primary_source_type_id`)
    REFERENCES `spd_scrubbed`.`primary_source` (`primary_source_id`),
  ...
  CONSTRAINT `fk_fhir_codeable_concept_communication1`
    ...
    REFERENCES `spd_scrubbed`.`communication` (`communication_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_fhir_codeable_concept_ehr1`
    FOREIGN KEY (`ehr_patient_access_id`)
    REFERENCES `spd_scrubbed`.`ehr` (`vhdir_ehr_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`fhir_meta_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`fhir_meta_data` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`fhir_meta_data` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`general_cost`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`general_cost` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`general_cost` (
  ...
  CONSTRAINT `fk_general_cost_plan1`
    FOREIGN KEY (`plan_id`)
    REFERENCES `spd_scrubbed`.`plan` (`plan_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`identifier`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`identifier` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`identifier` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`limit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`limit` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`limit` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`name`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`name` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`name` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`new_patient_profile`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`new_patient_profile` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`new_patient_profile` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`new_patients`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`new_patients` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`new_patients` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`not_available_time`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`not_available_time` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`not_available_time` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`note`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`note` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`note` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`organization_alias`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`organization_alias` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`organization_alias` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`organization_taxonomy`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`organization_taxonomy` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`organization_taxonomy` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`participant`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`participant` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`participant` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`plan`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`plan` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`plan` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`policy`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`policy` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`policy` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`primary_source`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`primary_source` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`primary_source` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`provision`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`provision` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`provision` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`qualification`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`qualification` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`qualification` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`qualification_history`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`qualification_history` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`qualification_history` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`resource_reference`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`resource_reference` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`resource_reference` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`specific_cost`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`specific_cost` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`specific_cost` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`specific_cost_benefit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`specific_cost_benefit` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`specific_cost_benefit` (
  ...
  CONSTRAINT `fk_cost_benefit_specific_cost1`
    ...
    REFERENCES `spd_scrubbed`.`specific_cost` (`specific_cost_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`specific_cost_benefit_cost`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`specific_cost_benefit_cost` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`specific_cost_benefit_cost` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`telecom`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`telecom` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`telecom` (
  ...
  CONSTRAINT `fk_telecom_contact1`
    ...
    REFERENCES `spd_scrubbed`.`contact` (`contact_id`),
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`trust_framework`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`trust_framework` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`trust_framework` (
  ...
  CONSTRAINT `fk_trust_framework_digital_certificate1`
    ...
    REFERENCES `spd_scrubbed`.`digital_certificate` (`digital_certificate_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`use_case`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`use_case` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`use_case` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`validator`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`validator` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`validator` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`vhdir_careteam`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`vhdir_careteam` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`vhdir_careteam` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`vhdir_endpoint`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`vhdir_endpoint` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`vhdir_endpoint` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`vhdir_healthcare_service`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`vhdir_healthcare_service` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`vhdir_healthcare_service` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`vhdir_insurance_plan`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`vhdir_insurance_plan` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`vhdir_insurance_plan` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`vhdir_location`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`vhdir_location` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`vhdir_location` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`vhdir_network`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`vhdir_network` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`vhdir_network` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`vhdir_organization`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`vhdir_organization` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`vhdir_organization` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`vhdir_organization_affiliation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`vhdir_organization_affiliation` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`vhdir_organization_affiliation` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`vhdir_practitioner`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`vhdir_practitioner` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`vhdir_practitioner` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`vhdir_practitioner_role`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`vhdir_practitioner_role` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`vhdir_practitioner_role` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`vhdir_restriction`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`vhdir_restriction` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`vhdir_restriction` (
...
-- -----------------------------------------------------
-- Table `spd_scrubbed`.`vhdir_validation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_scrubbed`.`vhdir_validation` ;

CREATE TABLE IF NOT EXISTS `spd_scrubbed`.`vhdir_validation` (
