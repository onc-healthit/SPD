...
-- -----------------------------------------------------
-- Table `spd_large`.`communication_proficiency`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`communication_proficiency` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`communication_proficiency` (
