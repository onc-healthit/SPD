...
-- -----------------------------------------------------
-- Table `spd_large`.`cost_benefit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`cost_benefit` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`cost_benefit` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`cost_benefit_individual_cost`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`cost_benefit_individual_cost` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`cost_benefit_individual_cost` (
  ...
  CONSTRAINT `fk_cost_benefit_individual_cost_cost_benefit1`
    ...
    REFERENCES `spd_large`.`cost_benefit` (`cost_benefit_id`),
...
CREATE TABLE IF NOT EXISTS `spd_large`.`fhir_codeable_concept` (
  ...
  CONSTRAINT `fk_fhir_codeable_concept_cost_benefit_individual_cost1`
    ...
    REFERENCES `spd_large`.`cost_benefit_individual_cost` (`cost_benefit_individual_cost_id`),
...
CREATE TABLE IF NOT EXISTS `spd_large`.`limit` (
  ...
  CONSTRAINT `fk_limit_benefit1`
    ...
    REFERENCES `spd_large`.`plan_benefit` (`benefit_id`),
...
-- -----------------------------------------------------
-- Table `spd_large`.`plan_benefit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`plan_benefit` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`plan_benefit` (
