...
-- -----------------------------------------------------
-- Table `spd_large`.`organization_contact`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`organization_contact` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`organization_contact` (
...
CREATE TABLE IF NOT EXISTS `spd_large`.`telecom` (
  ...
  CONSTRAINT `fk_telecom_organization_contact1`
    ...
    REFERENCES `spd_large`.`organization_contact` (`organization_contact_id`),
