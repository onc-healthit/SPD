...
CREATE TABLE IF NOT EXISTS `spd_large`.`available_time` (
  ...
  CONSTRAINT `fk_available_time_endpoint_contact1`
    ...
    REFERENCES `spd_large`.`endpoint_contact` (`endpoint_contact_id`),
...
-- -----------------------------------------------------
-- Table `spd_large`.`endpoint_contact`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`endpoint_contact` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`endpoint_contact` (
