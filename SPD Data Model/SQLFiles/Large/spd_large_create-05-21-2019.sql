...
-- Schema spd_large
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `spd_large` ;

-- -----------------------------------------------------
-- Schema spd_large
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `spd_large` DEFAULT CHARACTER SET utf8 ;
USE `spd_large` ;

-- -----------------------------------------------------
-- Table `spd_large`.`actor`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`actor` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`actor` (
  ...
  CONSTRAINT `fk_actor_fhir_codeable_concept1`
    ...
    REFERENCES `spd_large`.`fhir_codeable_concept` (`codeable_concept_id`),
  CONSTRAINT `fk_actor_provision1`
    FOREIGN KEY (`provision_id`)
    REFERENCES `spd_large`.`provision` (`provision_id`),
  CONSTRAINT `fk_actor_resource_reference1`
    FOREIGN KEY (`reference_resource_id`)
    REFERENCES `spd_large`.`resource_reference` (`resource_reference_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `spd_large`.`address`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`address` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`address` (
  ...
  CONSTRAINT `address_practitioner_id`
    ...
    REFERENCES `spd_large`.`vhdir_practitioner` (`practitioner_id`)
    ON DELETE CASCADE,
  CONSTRAINT `fk_address_network1`
    FOREIGN KEY (`network_id`)
    REFERENCES `spd_large`.`vhdir_network` (`network_id`),
  CONSTRAINT `fk_address_organization1`
    FOREIGN KEY (`organization_id`)
    REFERENCES `spd_large`.`vhdir_organization` (`organization_id`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `spd_large`.`attestation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`attestation` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`attestation` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`available_time`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`available_time` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`available_time` (
  ...
  CONSTRAINT `fk_available_time_healthcare_service1`
    ...
    REFERENCES `spd_large`.`vhdir_healthcare_service` (`healthcare_service_id`),
  CONSTRAINT `fk_available_time_location1`
    FOREIGN KEY (`location_hours_of_operation_id`)
    REFERENCES `spd_large`.`vhdir_location` (`location_id`),
  CONSTRAINT `fk_available_time_practitioner_role1`
    FOREIGN KEY (`practitioner_role_id`)
    REFERENCES `spd_large`.`vhdir_practitioner_role` (`practitioner_role_id`),
  CONSTRAINT `fk_available_time_telecom1`
    FOREIGN KEY (`telecom_id`)
    REFERENCES `spd_large`.`telecom` (`telecom_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_large`.`care_team_alias`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`care_team_alias` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`care_team_alias` (
  ...
  CONSTRAINT `fk_care_team_alias_careteam1`
    ...
    REFERENCES `spd_large`.`vhdir_careteam` (`careteam_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_large`.`communication`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`communication` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`communication` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`consent`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`consent` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`consent` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`contact`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`contact` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`contact` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`coverage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`coverage` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`coverage` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`coverage_benefit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`coverage_benefit` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`coverage_benefit` (
  ...
  CONSTRAINT `fk_benefit_coverage1`
    ...
    REFERENCES `spd_large`.`coverage` (`coverage_id`),
...
-- -----------------------------------------------------
-- Table `spd_large`.`digital_certificate`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`digital_certificate` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`digital_certificate` (
  ...
  CONSTRAINT `fk_digital_certificate_endpoint1`
    ...
    REFERENCES `spd_large`.`vhdir_endpoint` (`endpoint_id`),
...
-- Table `spd_large`.`ehr`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`ehr` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`ehr` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`eligibility`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`eligibility` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`eligibility` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`encounter_reference`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`encounter_reference` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`encounter_reference` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`fhir_codeable_concept`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`fhir_codeable_concept` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`fhir_codeable_concept` (
  ...
  CONSTRAINT `fk_codeable_concept_organization_affiliation1`
    ...
    REFERENCES `spd_large`.`vhdir_organization_affiliation` (`organization_affiliation_id`),
...
-- -----------------------------------------------------
-- Table `spd_large`.`fhir_meta_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`fhir_meta_data` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`fhir_meta_data` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`general_cost`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`general_cost` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`general_cost` (
  ...
  CONSTRAINT `fk_general_cost_plan1`
    FOREIGN KEY (`plan_id`)
    REFERENCES `spd_large`.`plan` (`plan_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_large`.`identifier`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`identifier` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`identifier` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`limit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`limit` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`limit` (
  ...
  CONSTRAINT `fk_limit_benefit1`
    ...
    REFERENCES `spd_large`.`coverage_benefit` (`benefit_id`),
...
-- -----------------------------------------------------
-- Table `spd_large`.`name`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`name` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`name` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`new_patient_profile`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`new_patient_profile` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`new_patient_profile` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`new_patients`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`new_patients` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`new_patients` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`not_available_time`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`not_available_time` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`not_available_time` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`note`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`note` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`note` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`organization_alias`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`organization_alias` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`organization_alias` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`organization_taxonomy`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`organization_taxonomy` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`organization_taxonomy` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`participant`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`participant` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`participant` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`plan`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`plan` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`plan` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`policy`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`policy` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`policy` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`primary_source`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`primary_source` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`primary_source` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`provision`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`provision` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`provision` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`qualification`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`qualification` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`qualification` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`qualification_history`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`qualification_history` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`qualification_history` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`resource_reference`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`resource_reference` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`resource_reference` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`specific_cost`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`specific_cost` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`specific_cost` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`specific_cost_benefit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`specific_cost_benefit` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`specific_cost_benefit` (
  ...
  CONSTRAINT `fk_cost_benefit_specific_cost1`
    ...
    REFERENCES `spd_large`.`specific_cost` (`specific_cost_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_large`.`specific_cost_benefit_cost`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`specific_cost_benefit_cost` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`specific_cost_benefit_cost` (
  ...
  CONSTRAINT `fk_cost_benefit_individual_cost_cost_benefit1`
    ...
    REFERENCES `spd_large`.`specific_cost_benefit` (`cost_benefit_id`),
...
-- -----------------------------------------------------
-- Table `spd_large`.`telecom`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`telecom` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`telecom` (
  ...
  CONSTRAINT `fk_telecom_contact1`
    ...
    REFERENCES `spd_large`.`contact` (`contact_id`),
...
-- -----------------------------------------------------
-- Table `spd_large`.`trust_framework`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`trust_framework` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`trust_framework` (
  ...
  CONSTRAINT `fk_trust_framework_digital_certificate1`
    ...
    REFERENCES `spd_large`.`digital_certificate` (`digital_certificate_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_large`.`use_case`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`use_case` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`use_case` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`validator`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`validator` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`validator` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`vhdir_careteam`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`vhdir_careteam` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`vhdir_careteam` (
  ...
  CONSTRAINT `fk_careteam_encounter1`
    ...
    REFERENCES `spd_large`.`encounter_reference` (`encounter_id`),
  CONSTRAINT `fk_careteam_meta_data1`
    FOREIGN KEY (`meta_data_id`)
    REFERENCES `spd_large`.`fhir_meta_data` (`meta_data_id`),
...
-- -----------------------------------------------------
-- Table `spd_large`.`vhdir_endpoint`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`vhdir_endpoint` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`vhdir_endpoint` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`vhdir_healthcare_service`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`vhdir_healthcare_service` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`vhdir_healthcare_service` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`vhdir_insurance_plan`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`vhdir_insurance_plan` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`vhdir_insurance_plan` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`vhdir_location`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`vhdir_location` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`vhdir_location` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`vhdir_network`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`vhdir_network` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`vhdir_network` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`vhdir_organization`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`vhdir_organization` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`vhdir_organization` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`vhdir_organization_affiliation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`vhdir_organization_affiliation` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`vhdir_organization_affiliation` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`vhdir_practitioner`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`vhdir_practitioner` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`vhdir_practitioner` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`vhdir_practitioner_role`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`vhdir_practitioner_role` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`vhdir_practitioner_role` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`vhdir_restriction`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`vhdir_restriction` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`vhdir_restriction` (
...
-- -----------------------------------------------------
-- Table `spd_large`.`vhdir_validation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large`.`vhdir_validation` ;

CREATE TABLE IF NOT EXISTS `spd_large`.`vhdir_validation` (
  ...
  CONSTRAINT `fk_vhdir_validation_attestation1`
    ...
    REFERENCES `spd_large`.`attestation` (`attestation_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
