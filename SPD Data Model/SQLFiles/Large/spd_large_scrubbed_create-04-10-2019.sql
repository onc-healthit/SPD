...
-- -----------------------------------------------------
-- Table `spd_large_scrubbed`.`communication_proficiency`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_large_scrubbed`.`communication_proficiency` ;

CREATE TABLE IF NOT EXISTS `spd_large_scrubbed`.`communication_proficiency` (
