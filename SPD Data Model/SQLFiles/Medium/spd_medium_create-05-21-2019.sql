...
CREATE TABLE IF NOT EXISTS `spd_medium`.`available_time` (
  ...
  CONSTRAINT `fk_available_time_telecom1`
    ...
    REFERENCES `spd_medium`.`telecom` (`telecom_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_medium`.`coverage_benefit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_medium`.`coverage_benefit` ;

CREATE TABLE IF NOT EXISTS `spd_medium`.`coverage_benefit` (
...
CREATE TABLE IF NOT EXISTS `spd_medium`.`fhir_codeable_concept` (
  ...
  CONSTRAINT `fk_fhir_codeable_concept_cost_benefit_individual_cost1`
    ...
    REFERENCES `spd_medium`.`specific_cost_benefit_cost` (`cost_benefit_individual_cost_id`),
  ...
  CONSTRAINT `fk_fhir_codeable_concept_ehr1`
    ...
    REFERENCES `spd_medium`.`ehr` (`vhdir_ehr_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
CREATE TABLE IF NOT EXISTS `spd_medium`.`limit` (
  ...
  CONSTRAINT `fk_limit_benefit1`
    ...
    REFERENCES `spd_medium`.`coverage_benefit` (`benefit_id`),
...
-- -----------------------------------------------------
-- Table `spd_medium`.`specific_cost_benefit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_medium`.`specific_cost_benefit` ;

CREATE TABLE IF NOT EXISTS `spd_medium`.`specific_cost_benefit` (
...
-- -----------------------------------------------------
-- Table `spd_medium`.`specific_cost_benefit_cost`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_medium`.`specific_cost_benefit_cost` ;

CREATE TABLE IF NOT EXISTS `spd_medium`.`specific_cost_benefit_cost` (
  ...
  CONSTRAINT `fk_cost_benefit_individual_cost_cost_benefit1`
    ...
    REFERENCES `spd_medium`.`specific_cost_benefit` (`cost_benefit_id`),
