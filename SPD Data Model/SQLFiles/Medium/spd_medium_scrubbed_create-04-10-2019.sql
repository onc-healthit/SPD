...
-- -----------------------------------------------------
-- Table `spd_medium_scrubbed`.`communication_proficiency`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_medium_scrubbed`.`communication_proficiency` ;

CREATE TABLE IF NOT EXISTS `spd_medium_scrubbed`.`communication_proficiency` (
