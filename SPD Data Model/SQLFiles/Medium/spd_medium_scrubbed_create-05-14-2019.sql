...
-- -----------------------------------------------------
-- Table `spd_medium_scrubbed`.`organization_contact`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_medium_scrubbed`.`organization_contact` ;

CREATE TABLE IF NOT EXISTS `spd_medium_scrubbed`.`organization_contact` (
...
CREATE TABLE IF NOT EXISTS `spd_medium_scrubbed`.`telecom` (
  ...
  CONSTRAINT `fk_telecom_organization_contact1`
    ...
    REFERENCES `spd_medium_scrubbed`.`organization_contact` (`organization_contact_id`),
