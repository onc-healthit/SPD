...
-- -----------------------------------------------------
-- Table `spd_small`.`communication_proficiency`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`communication_proficiency` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`communication_proficiency` (
