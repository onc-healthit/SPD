...
-- -----------------------------------------------------
-- Table `spd_small`.`cost_benefit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`cost_benefit` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`cost_benefit` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`cost_benefit_individual_cost`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`cost_benefit_individual_cost` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`cost_benefit_individual_cost` (
  ...
  CONSTRAINT `fk_cost_benefit_individual_cost_cost_benefit1`
    ...
    REFERENCES `spd_small`.`cost_benefit` (`cost_benefit_id`),
...
CREATE TABLE IF NOT EXISTS `spd_small`.`fhir_codeable_concept` (
  ...
  CONSTRAINT `fk_fhir_codeable_concept_cost_benefit_individual_cost1`
    ...
    REFERENCES `spd_small`.`cost_benefit_individual_cost` (`cost_benefit_individual_cost_id`),
...
CREATE TABLE IF NOT EXISTS `spd_small`.`limit` (
  ...
  CONSTRAINT `fk_limit_benefit1`
    ...
    REFERENCES `spd_small`.`plan_benefit` (`benefit_id`),
...
-- -----------------------------------------------------
-- Table `spd_small`.`plan_benefit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`plan_benefit` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`plan_benefit` (
