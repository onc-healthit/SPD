...
-- -----------------------------------------------------
-- Table `spd_small`.`organization_contact`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`organization_contact` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`organization_contact` (
...
CREATE TABLE IF NOT EXISTS `spd_small`.`telecom` (
  ...
  CONSTRAINT `fk_telecom_organization_contact1`
    ...
    REFERENCES `spd_small`.`organization_contact` (`organization_contact_id`),
