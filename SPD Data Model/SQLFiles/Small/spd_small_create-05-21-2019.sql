...
-- Schema spd_small
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `spd_small` ;

-- -----------------------------------------------------
-- Schema spd_small
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `spd_small` DEFAULT CHARACTER SET utf8 ;
USE `spd_small` ;

-- -----------------------------------------------------
-- Table `spd_small`.`actor`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`actor` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`actor` (
  ...
  CONSTRAINT `fk_actor_fhir_codeable_concept1`
    ...
    REFERENCES `spd_small`.`fhir_codeable_concept` (`codeable_concept_id`),
  CONSTRAINT `fk_actor_provision1`
    FOREIGN KEY (`provision_id`)
    REFERENCES `spd_small`.`provision` (`provision_id`),
  CONSTRAINT `fk_actor_resource_reference1`
    FOREIGN KEY (`reference_resource_id`)
    REFERENCES `spd_small`.`resource_reference` (`resource_reference_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `spd_small`.`address`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`address` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`address` (
  ...
  CONSTRAINT `address_practitioner_id`
    ...
    REFERENCES `spd_small`.`vhdir_practitioner` (`practitioner_id`)
    ON DELETE CASCADE,
  CONSTRAINT `fk_address_network1`
    FOREIGN KEY (`network_id`)
    REFERENCES `spd_small`.`vhdir_network` (`network_id`),
  CONSTRAINT `fk_address_organization1`
    FOREIGN KEY (`organization_id`)
    REFERENCES `spd_small`.`vhdir_organization` (`organization_id`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `spd_small`.`attestation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`attestation` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`attestation` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`available_time`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`available_time` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`available_time` (
  ...
  CONSTRAINT `fk_available_time_healthcare_service1`
    ...
    REFERENCES `spd_small`.`vhdir_healthcare_service` (`healthcare_service_id`),
  CONSTRAINT `fk_available_time_location1`
    FOREIGN KEY (`location_hours_of_operation_id`)
    REFERENCES `spd_small`.`vhdir_location` (`location_id`),
  CONSTRAINT `fk_available_time_practitioner_role1`
    FOREIGN KEY (`practitioner_role_id`)
    REFERENCES `spd_small`.`vhdir_practitioner_role` (`practitioner_role_id`),
  CONSTRAINT `fk_available_time_telecom1`
    FOREIGN KEY (`telecom_id`)
    REFERENCES `spd_small`.`telecom` (`telecom_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_small`.`care_team_alias`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`care_team_alias` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`care_team_alias` (
  ...
  CONSTRAINT `fk_care_team_alias_careteam1`
    ...
    REFERENCES `spd_small`.`vhdir_careteam` (`careteam_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_small`.`communication`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`communication` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`communication` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`consent`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`consent` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`consent` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`contact`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`contact` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`contact` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`coverage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`coverage` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`coverage` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`coverage_benefit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`coverage_benefit` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`coverage_benefit` (
  ...
  CONSTRAINT `fk_benefit_coverage1`
    ...
    REFERENCES `spd_small`.`coverage` (`coverage_id`),
...
-- -----------------------------------------------------
-- Table `spd_small`.`digital_certificate`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`digital_certificate` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`digital_certificate` (
  ...
  CONSTRAINT `fk_digital_certificate_endpoint1`
    ...
    REFERENCES `spd_small`.`vhdir_endpoint` (`endpoint_id`),
...
-- Table `spd_small`.`ehr`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`ehr` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`ehr` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`eligibility`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`eligibility` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`eligibility` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`encounter_reference`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`encounter_reference` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`encounter_reference` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`fhir_codeable_concept`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`fhir_codeable_concept` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`fhir_codeable_concept` (
  ...
  CONSTRAINT `fk_codeable_concept_organization_affiliation1`
    ...
    REFERENCES `spd_small`.`vhdir_organization_affiliation` (`organization_affiliation_id`),
...
-- -----------------------------------------------------
-- Table `spd_small`.`fhir_meta_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`fhir_meta_data` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`fhir_meta_data` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`general_cost`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`general_cost` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`general_cost` (
  ...
  CONSTRAINT `fk_general_cost_plan1`
    FOREIGN KEY (`plan_id`)
    REFERENCES `spd_small`.`plan` (`plan_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_small`.`identifier`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`identifier` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`identifier` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`limit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`limit` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`limit` (
  ...
  CONSTRAINT `fk_limit_benefit1`
    ...
    REFERENCES `spd_small`.`coverage_benefit` (`benefit_id`),
...
-- -----------------------------------------------------
-- Table `spd_small`.`name`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`name` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`name` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`new_patient_profile`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`new_patient_profile` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`new_patient_profile` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`new_patients`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`new_patients` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`new_patients` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`not_available_time`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`not_available_time` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`not_available_time` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`note`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`note` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`note` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`organization_alias`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`organization_alias` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`organization_alias` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`organization_taxonomy`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`organization_taxonomy` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`organization_taxonomy` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`participant`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`participant` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`participant` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`plan`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`plan` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`plan` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`policy`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`policy` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`policy` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`primary_source`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`primary_source` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`primary_source` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`provision`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`provision` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`provision` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`qualification`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`qualification` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`qualification` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`qualification_history`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`qualification_history` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`qualification_history` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`resource_reference`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`resource_reference` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`resource_reference` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`specific_cost`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`specific_cost` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`specific_cost` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`specific_cost_benefit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`specific_cost_benefit` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`specific_cost_benefit` (
  ...
  CONSTRAINT `fk_cost_benefit_specific_cost1`
    ...
    REFERENCES `spd_small`.`specific_cost` (`specific_cost_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_small`.`specific_cost_benefit_cost`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`specific_cost_benefit_cost` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`specific_cost_benefit_cost` (
  ...
  CONSTRAINT `fk_cost_benefit_individual_cost_cost_benefit1`
    ...
    REFERENCES `spd_small`.`specific_cost_benefit` (`cost_benefit_id`),
...
-- -----------------------------------------------------
-- Table `spd_small`.`telecom`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`telecom` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`telecom` (
  ...
  CONSTRAINT `fk_telecom_contact1`
    ...
    REFERENCES `spd_small`.`contact` (`contact_id`),
...
-- -----------------------------------------------------
-- Table `spd_small`.`trust_framework`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`trust_framework` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`trust_framework` (
  ...
  CONSTRAINT `fk_trust_framework_digital_certificate1`
    ...
    REFERENCES `spd_small`.`digital_certificate` (`digital_certificate_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_small`.`use_case`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`use_case` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`use_case` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`validator`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`validator` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`validator` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`vhdir_careteam`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`vhdir_careteam` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`vhdir_careteam` (
  ...
  CONSTRAINT `fk_careteam_encounter1`
    ...
    REFERENCES `spd_small`.`encounter_reference` (`encounter_id`),
  CONSTRAINT `fk_careteam_meta_data1`
    FOREIGN KEY (`meta_data_id`)
    REFERENCES `spd_small`.`fhir_meta_data` (`meta_data_id`),
...
-- -----------------------------------------------------
-- Table `spd_small`.`vhdir_endpoint`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`vhdir_endpoint` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`vhdir_endpoint` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`vhdir_healthcare_service`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`vhdir_healthcare_service` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`vhdir_healthcare_service` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`vhdir_insurance_plan`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`vhdir_insurance_plan` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`vhdir_insurance_plan` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`vhdir_location`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`vhdir_location` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`vhdir_location` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`vhdir_network`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`vhdir_network` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`vhdir_network` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`vhdir_organization`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`vhdir_organization` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`vhdir_organization` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`vhdir_organization_affiliation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`vhdir_organization_affiliation` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`vhdir_organization_affiliation` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`vhdir_practitioner`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`vhdir_practitioner` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`vhdir_practitioner` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`vhdir_practitioner_role`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`vhdir_practitioner_role` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`vhdir_practitioner_role` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`vhdir_restriction`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`vhdir_restriction` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`vhdir_restriction` (
...
-- -----------------------------------------------------
-- Table `spd_small`.`vhdir_validation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small`.`vhdir_validation` ;

CREATE TABLE IF NOT EXISTS `spd_small`.`vhdir_validation` (
  ...
  CONSTRAINT `fk_vhdir_validation_attestation1`
    ...
    REFERENCES `spd_small`.`attestation` (`attestation_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
