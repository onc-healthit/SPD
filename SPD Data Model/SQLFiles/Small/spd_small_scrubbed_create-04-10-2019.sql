...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed`.`communication_proficiency`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed`.`communication_proficiency` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed`.`communication_proficiency` (
