...
-- -----------------------------------------------------
-- Schema spd_small_scrubbed_scrubbed
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `spd_small_scrubbed_scrubbed` ;

-- -----------------------------------------------------
-- Schema spd_small_scrubbed_scrubbed
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `spd_small_scrubbed_scrubbed` DEFAULT CHARACTER SET utf8 ;
USE `spd_small_scrubbed_scrubbed` ;

-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`actor`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`actor` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`actor` (
  ...
  CONSTRAINT `fk_actor_fhir_codeable_concept1`
    ...
    REFERENCES `spd_small_scrubbed_scrubbed`.`fhir_codeable_concept` (`codeable_concept_id`),
  CONSTRAINT `fk_actor_provision1`
    FOREIGN KEY (`provision_id`)
    REFERENCES `spd_small_scrubbed_scrubbed`.`provision` (`provision_id`),
  CONSTRAINT `fk_actor_resource_reference1`
    FOREIGN KEY (`reference_resource_id`)
    REFERENCES `spd_small_scrubbed_scrubbed`.`resource_reference` (`resource_reference_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`address`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`address` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`address` (
  ...
  CONSTRAINT `address_practitioner_id`
    ...
    REFERENCES `spd_small_scrubbed_scrubbed`.`vhdir_practitioner` (`practitioner_id`)
    ON DELETE CASCADE,
  CONSTRAINT `fk_address_network1`
    FOREIGN KEY (`network_id`)
    REFERENCES `spd_small_scrubbed_scrubbed`.`vhdir_network` (`network_id`),
  CONSTRAINT `fk_address_organization1`
    FOREIGN KEY (`organization_id`)
    REFERENCES `spd_small_scrubbed_scrubbed`.`vhdir_organization` (`organization_id`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`attestation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`attestation` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`attestation` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`available_time`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`available_time` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`available_time` (
  ...
  CONSTRAINT `fk_available_time_endpoint_contact1`
    ...
    REFERENCES `spd_small_scrubbed_scrubbed`.`endpoint_contact` (`endpoint_contact_id`),
  CONSTRAINT `fk_available_time_healthcare_service1`
    FOREIGN KEY (`healthcare_service_id`)
    REFERENCES `spd_small_scrubbed_scrubbed`.`vhdir_healthcare_service` (`healthcare_service_id`),
  CONSTRAINT `fk_available_time_location1`
    FOREIGN KEY (`location_hours_of_operation_id`)
    REFERENCES `spd_small_scrubbed_scrubbed`.`vhdir_location` (`location_id`),
  CONSTRAINT `fk_available_time_practitioner_role1`
    FOREIGN KEY (`practitioner_role_id`)
    REFERENCES `spd_small_scrubbed_scrubbed`.`vhdir_practitioner_role` (`practitioner_role_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`care_team_alias`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`care_team_alias` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`care_team_alias` (
  ...
  CONSTRAINT `fk_care_team_alias_careteam1`
    ...
    REFERENCES `spd_small_scrubbed_scrubbed`.`vhdir_careteam` (`careteam_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`communication`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`communication` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`communication` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`consent`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`consent` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`consent` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`contact`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`contact` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`contact` (
  ...
  CONSTRAINT `fk_contact_address1`
    ...
    REFERENCES `spd_small_scrubbed_scrubbed`.`address` (`address_id`),
  CONSTRAINT `fk_contact_fhir_codeable_concept1`
    FOREIGN KEY (`purpose_cc_id`)
    REFERENCES `spd_small_scrubbed_scrubbed`.`fhir_codeable_concept` (`codeable_concept_id`),
  CONSTRAINT `fk_contact_name1`
    FOREIGN KEY (`name_id`)
    REFERENCES `spd_small_scrubbed_scrubbed`.`name` (`name_id`),
  CONSTRAINT `fk_contact_vhdir_insurance_plan1`
    FOREIGN KEY (`insurance_plan_id`)
    REFERENCES `spd_small_scrubbed_scrubbed`.`vhdir_insurance_plan` (`insurance_plan_id`),
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`cost_benefit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`cost_benefit` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`cost_benefit` (
  ...
  CONSTRAINT `fk_cost_benefit_specific_cost1`
    ...
    REFERENCES `spd_small_scrubbed_scrubbed`.`specific_cost` (`specific_cost_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`cost_benefit_individual_cost`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`cost_benefit_individual_cost` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`cost_benefit_individual_cost` (
  ...
  CONSTRAINT `fk_cost_benefit_individual_cost_cost_benefit1`
    ...
    REFERENCES `spd_small_scrubbed_scrubbed`.`cost_benefit` (`cost_benefit_id`),
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`coverage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`coverage` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`coverage` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`digital_certificate`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`digital_certificate` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`digital_certificate` (
  ...
  CONSTRAINT `fk_digital_certificate_endpoint1`
    ...
    REFERENCES `spd_small_scrubbed_scrubbed`.`vhdir_endpoint` (`endpoint_id`),
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`ehr`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`ehr` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`ehr` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`eligibility`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`eligibility` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`eligibility` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`encounter_reference`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`encounter_reference` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`encounter_reference` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`endpoint_contact`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`endpoint_contact` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`endpoint_contact` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`fhir_codeable_concept`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`fhir_codeable_concept` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`fhir_codeable_concept` (
  ...
  CONSTRAINT `fk_codeable_concept_organization_affiliation1`
    ...
    REFERENCES `spd_small_scrubbed_scrubbed`.`vhdir_organization_affiliation` (`organization_affiliation_id`),
  ...
  CONSTRAINT `fk_codeable_concept_qualification1`
    ...
    REFERENCES `spd_small_scrubbed_scrubbed`.`qualification` (`qualification_id`),
  CONSTRAINT `fk_codeable_concept_validation1`
    FOREIGN KEY (`validation_process_id`)
    REFERENCES `spd_small_scrubbed_scrubbed`.`vhdir_validation` (`validation_id`),
  CONSTRAINT `fk_fhir_codeable_concept_cost_benefit_individual_cost1`
    FOREIGN KEY (`plan_cost_qualifier`)
    REFERENCES `spd_small_scrubbed_scrubbed`.`cost_benefit_individual_cost` (`cost_benefit_individual_cost_id`),
  CONSTRAINT `fk_fhir_codeable_concept_participant1`
    FOREIGN KEY (`careteam_participant_role_id`)
    REFERENCES `spd_small_scrubbed_scrubbed`.`participant` (`participant_id`),
  CONSTRAINT `fk_fhir_codeable_concept_primary_source1`
    FOREIGN KEY (`primary_source_type_id`)
    REFERENCES `spd_small_scrubbed_scrubbed`.`primary_source` (`primary_source_id`),
  ...
  CONSTRAINT `fk_fhir_codeable_concept_vhdir_restriction1`
    ...
    REFERENCES `spd_small_scrubbed_scrubbed`.`vhdir_restriction` (`restriction_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_fhir_codeable_concept_communication1`
    FOREIGN KEY (`communication_id`)
    REFERENCES `spd_small_scrubbed_scrubbed`.`communication` (`communication_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_fhir_codeable_concept_ehr1`
    FOREIGN KEY (`ehr_patient_access_id`)
    REFERENCES `spd_small_scrubbed_scrubbed`.`ehr` (`vhdir_ehr_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`fhir_meta_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`fhir_meta_data` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`fhir_meta_data` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`general_cost`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`general_cost` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`general_cost` (
  ...
  CONSTRAINT `fk_general_cost_plan1`
    FOREIGN KEY (`plan_id`)
    REFERENCES `spd_small_scrubbed_scrubbed`.`plan` (`plan_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`identifier`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`identifier` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`identifier` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`limit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`limit` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`limit` (
  ...
  CONSTRAINT `fk_limit_benefit1`
    ...
    REFERENCES `spd_small_scrubbed_scrubbed`.`plan_benefit` (`benefit_id`),
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`name`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`name` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`name` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`new_patient_profile`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`new_patient_profile` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`new_patient_profile` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`new_patients`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`new_patients` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`new_patients` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`not_available_time`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`not_available_time` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`not_available_time` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`note`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`note` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`note` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`organization_alias`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`organization_alias` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`organization_alias` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`organization_contact`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`organization_contact` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`organization_contact` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`organization_taxonomy`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`organization_taxonomy` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`organization_taxonomy` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`participant`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`participant` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`participant` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`plan`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`plan` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`plan` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`plan_benefit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`plan_benefit` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`plan_benefit` (
  ...
  CONSTRAINT `fk_benefit_coverage1`
    ...
    REFERENCES `spd_small_scrubbed_scrubbed`.`coverage` (`coverage_id`),
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`policy`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`policy` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`policy` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`primary_source`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`primary_source` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`primary_source` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`provision`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`provision` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`provision` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`qualification`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`qualification` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`qualification` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`qualification_history`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`qualification_history` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`qualification_history` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`resource_reference`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`resource_reference` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`resource_reference` (
  ...
  `network_location_id` INT(11) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`specific_cost`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`specific_cost` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`specific_cost` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`telecom`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`telecom` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`telecom` (
  ...
  CONSTRAINT `fk_telecom_contact1`
    ...
    REFERENCES `spd_small_scrubbed_scrubbed`.`contact` (`contact_id`),
  ...
  CONSTRAINT `fk_telecom_organization_contact1`
    ...
    REFERENCES `spd_small_scrubbed_scrubbed`.`organization_contact` (`organization_contact_id`),
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`trust_framework`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`trust_framework` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`trust_framework` (
  ...
  CONSTRAINT `fk_trust_framework_digital_certificate1`
    ...
    REFERENCES `spd_small_scrubbed_scrubbed`.`digital_certificate` (`digital_certificate_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`use_case`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`use_case` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`use_case` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`validator`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`validator` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`validator` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`vhdir_careteam`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_careteam` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_careteam` (
  ...
  CONSTRAINT `fk_careteam_encounter1`
    ...
    REFERENCES `spd_small_scrubbed_scrubbed`.`encounter_reference` (`encounter_id`),
  CONSTRAINT `fk_careteam_meta_data1`
    FOREIGN KEY (`meta_data_id`)
    REFERENCES `spd_small_scrubbed_scrubbed`.`fhir_meta_data` (`meta_data_id`),
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`vhdir_endpoint`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_endpoint` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_endpoint` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`vhdir_healthcare_service`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_healthcare_service` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_healthcare_service` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`vhdir_insurance_plan`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_insurance_plan` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_insurance_plan` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`vhdir_location`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_location` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_location` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`vhdir_network`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_network` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_network` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`vhdir_organization`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_organization` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_organization` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`vhdir_organization_affiliation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_organization_affiliation` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_organization_affiliation` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`vhdir_practitioner`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_practitioner` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_practitioner` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`vhdir_practitioner_role`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_practitioner_role` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_practitioner_role` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`vhdir_restriction`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_restriction` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_restriction` (
...
-- -----------------------------------------------------
-- Table `spd_small_scrubbed_scrubbed`.`vhdir_validation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_validation` ;

CREATE TABLE IF NOT EXISTS `spd_small_scrubbed_scrubbed`.`vhdir_validation` (
  ...
  CONSTRAINT `fk_vhdir_validation_attestation1`
    ...
    REFERENCES `spd_small_scrubbed_scrubbed`.`attestation` (`attestation_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
