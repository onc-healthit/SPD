...
CREATE TABLE IF NOT EXISTS `spd`.`fhir_codeable_concept` (
  ...
  `text` VARCHAR(256) NULL DEFAULT NULL COMMENT 'Plain text representation of the concept',
  `coding_system` VARCHAR(256) NULL DEFAULT NULL COMMENT 'uri\\\\\\\\nIdentity of the terminology system',
  ...
  `coding_display` VARCHAR(256) NULL DEFAULT NULL COMMENT 'Representation defined by the system',
...
CREATE TABLE IF NOT EXISTS `spd`.`primary_source` (
  ...
  `validation_id` INT(11) NULL DEFAULT NULL,
  ...
  INDEX `fk_primary_source_vhdir_validation1_idx` (`validation_id` ASC) ,
  ...
  CONSTRAINT `fk_primary_source_resource_reference1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_primary_source_vhdir_validation1`
